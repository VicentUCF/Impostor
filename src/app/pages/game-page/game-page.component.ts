...
export class GamePageComponent implements OnDestroy, OnInit {
  ...
  ngOnInit(): void {
    this.seoService.setPage({
      ...
      description:
        'Configura jugadores, reparte roles y monta una partida de Algo No Cuadra desde un solo movil.',
      path: '/jugar',
      ...
      structuredData: {
        ...
        description:
          'Experiencia de juego para configurar una ronda del impostor desde un solo movil.',
        inLanguage: 'es',
        isPartOf: {
          '@type': 'WebSite',
          name: 'Algo No Cuadra',
        ...
        url: 'https://www.algonocuadra.app/jugar'
      }
    });
  ...
  private loadSavedConfig(): void {
    ...
    if (
      saved.hintDifficulty === 'easy' ||
      saved.hintDifficulty === 'normal' ||
      saved.hintDifficulty === 'hard'
    ) {
